...
# INSTALL DEPS  
RUN /nix/var/nix/profiles/per-user/guild/profile/bin/nix-env -i python3 libsodium tmux jq ncurses libtool autoconf git wget gnupg column less openssl vim \
